...
class LongShortTermMemory:
	...
	def __init__(self, df_train, df_validation, df_test, learning_rate=0.1, epochs=5000):
	...
	def developModels(self):
		...
		self.mdl0=keras.models.Sequential()
...
if __name__=='__main__':
	...
	ins0=LongShortTermMemory(learning_rate=0.02, epochs=3000
